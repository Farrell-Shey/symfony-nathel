 ...
 */
final class Version20210810122012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE beatmap (id INT AUTO_INCREMENT NOT NULL, beatmapset_id INT NOT NULL, difficulty VARCHAR(255) NOT NULL, bpm INT NOT NULL, ar INT NOT NULL, cs INT NOT NULL, drain INT NOT NULL, accuracy INT NOT NULL, hit_length INT NOT NULL, mode_int VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, INDEX IDX_F59F06C443EEE4D3 (beatmapset_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE beatmap DROP FOREIGN KEY FK_F59F06C443EEE4D3');
        ...
        $this->addSql('ALTER TABLE score DROP FOREIGN KEY FK_32993751F079958C');
        ...
        $this->addSql('ALTER TABLE mappool DROP FOREIGN KEY FK_C3A2B8F1C5737286');
        $this->addSql('ALTER TABLE tag_pool_set DROP FOREIGN KEY FK_ADE6CDD7C5737286');
        $this->addSql('ALTER TABLE tourney DROP FOREIGN KEY FK_FFF7213172FD9BA6');
        ...
        $this->addSql('ALTER TABLE mappool_followed DROP FOREIGN KEY FK_A0144DE1A76ED395');
        ...
        $this->addSql('DROP TABLE mappool_followed');
